package com.bricenangue.insyconn.ki_ki.fatsecret;
...
/**
 * Created by bricenangue on 20/01/2017.
 */

public class FatSecretSearch {

    String key = "7ba362e96fe949dab292c8a799e2ce49";
    String secret = "ca6765b60c49499db1c9d05d7de954e8";
    final static private String APP_METHOD = "GET";
    final static private String APP_KEY = "7ba362e96fe949dab292c8a799e2ce49";
     static private String APP_SECRET = "ca6765b60c49499db1c9d05d7de954e8";
    ...
    public JSONObject searchRecipe(String searchRecipe, int page) {
        List<String> params = new ArrayList<>(Arrays.asList(generateOauthParams(page)));
        String[] template = new String[1];
